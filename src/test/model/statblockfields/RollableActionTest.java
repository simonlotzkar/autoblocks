...
public class RollableActionTest {
    ...
    public void runBeforeEach() {
        ...
        testRollableAction0 = new RollableAction(testName0, testDescription0, testReach0, testRollFormula0, testDamageMap0);
        testRollableAction1 = new RollableAction(testName1, testDescription1, testReach1, testRollFormula1, testDamageMap1);
        testRollableAction2 = new RollableAction(testName1, testDescription0, testReach0, testRollFormula3, testDamageMap2);
    }
